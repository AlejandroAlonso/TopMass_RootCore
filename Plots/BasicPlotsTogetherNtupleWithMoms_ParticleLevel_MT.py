...
from AnalysisParticleLevelMT import *
...
if __name__ == "__main__":
    ...
    parser.add_argument("--TreeName"		,  type=str,  default = "particleLevel", help="Tree to read? AKA systematics")
    parser.add_argument("-D", '--inputdir' 	,  type=str,  default = "/lustre/hpc/hep/alonso/Top/AnalysisTop-2.4.27/Download")
    parser.add_argument("-O", '--outputdir'	,  type=str,  default = "plotParticleLevel")
    ...
    workers = {}
    for i in keys:
         analysis = analysisParticleLevelMT(   fortchain[i], nbjets, i,verbose)
         workers [i] = analysis 
